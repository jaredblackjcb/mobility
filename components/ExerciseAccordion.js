...
const ExerciseAccordion = props => {
    ...
    const resizedImage = image => {
        ...
        return (
            <Image source={image} style={{width: SCREEN_WIDTH, height: SCREEN_WIDTH*ratio, marginBottom: 15}} resizeMode="contain"/>
        );
    }
            ...
            return (
                <View key={item.id}>
                    <TouchableOpacity style={styles.row} onPress={() => {
                        ...
                        <Icon name={item.id === props.expandedId ? 'keyboard-arrow-up' : 'keyboard-arrow-down'} size={30} color={Colors.white} />
                    </TouchableOpacity>
